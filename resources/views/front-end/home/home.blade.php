                        ...
                        <div class="col-lg-8 border-start custom-border">
                            @foreach($blogs as $blog)
                                <div class="post-entry-1">
                                    <a href="{{route('blog.details',['slug'=>$blog->slug])}}"><img src="{{asset($blog->image)}}" style="height: 200px;width: 400px;" alt="" class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">{{$blog->category->category_name}}</span>
                                        <span class="mx-1">&bullet;</span> <span>{{date('',strtotime($blog->created_at))}}</span></div>
